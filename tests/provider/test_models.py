...
class TestApplicationUser:
    ...
    def test_get_permissions(self):
        ...
        p1 = ApplicationPermissionFactory(application=app, app_label='al1', codename='cn1')
        p2 = ApplicationPermissionFactory(application=app, app_label='al2', codename='cn2')
        p3 = ApplicationPermissionFactory(application=app, app_label='al3', codename='cn3')
        g1 = ApplicationPermissionGroupFactory.create(application=app, permissions=[p2, p3])
        app_user = ApplicationUserFactory.create(
            application=app, permissions=[p1, p2], groups=[g1]
        )
